...
export default function ErrorNotification() {
    ...
    //Contexts
    const { showError, setShowError } = useContext(ErrorNotificationContext);
                            ...
                            <div className="p-4">
                                <div className="flex items-start">
                                    <div className="flex-shrink-0">
                                        <svg xmlns="http://www.w3.org/2000/svg" className='fill-[#f20d19]'  height="16" width="16" viewBox="0 0 512 512"><path d="M256 512A256 256 0 1 0 256 0a256 256 0 1 0 0 512zM175 175c9.4-9.4 24.6-9.4 33.9 0l47 47 47-47c9.4-9.4 24.6-9.4 33.9 0s9.4 24.6 0 33.9l-47 47 47 47c9.4 9.4 9.4 24.6 0 33.9s-24.6 9.4-33.9 0l-47-47-47 47c-9.4 9.4-24.6 9.4-33.9 0s-9.4-24.6 0-33.9l47-47-47-47c-9.4-9.4-9.4-24.6 0-33.9z" /></svg>                                    
                                    </div>
                                    <div className="ml-3 w-0 flex-1 pt-0.5">
                                        <p className={`${darkModeActive ? 'text-[white]' : 'text-gray-900'} text-sm font-medium`}>{showError.message}</p>
                                    </div>
